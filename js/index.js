...
console.log('%c- Có vẻ như bạn đang cố tình ăn cắp mã nguồn của tôi </ Tunz >.', 'color: #444; font-size: 25px; font-family: sans-serif;');
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var audio = new Audio('./audio/AnhTuc-TaiLe-6132956.mp3');
